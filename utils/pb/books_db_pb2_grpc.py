...
import books_db_pb2 as books__db__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in books_db_pb2_grpc.py depends on'
...
class BooksDatabaseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Read = channel.unary_unary(
                '/bookstore.books_db.BooksDatabase/Read',
                request_serializer=books__db__pb2.ReadRequest.SerializeToString,
                response_deserializer=books__db__pb2.ReadResponse.FromString,
...
def add_BooksDatabaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Read': grpc.unary_unary_rpc_method_handler(
                    servicer.Read,
                    request_deserializer=books__db__pb2.ReadRequest.FromString,
                    response_serializer=books__db__pb2.ReadResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'bookstore.books_db.BooksDatabase', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('bookstore.books_db.BooksDatabase', rpc_method_handlers)
...
class BooksDatabase(object):
    ...
    def Read(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bookstore.books_db.BooksDatabase/Read',
            books__db__pb2.ReadRequest.SerializeToString,
            books__db__pb2.ReadResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
